...
public class ConsumerController {
    ...
    public R<List<Flowchart>> findAllFlowchart(@RequestHeader(KeyVals.Token) String token, FlowchartCriteria criteria) {
        Claims claims = JwtUtil.parseJwt(token);
        criteria.setConsumerId((String) claims.get("id"));
