export const MAINAPP_TOKEN_KEY = "BleuOn-Mainapp-Token";
export const SUBAPP_TOKEN_KEY = "BleuOn-Subapp-Token";
export const MAINAPP_THEME_MODE = "BleuOn-Mainapp-Theme-Mode";
export const SUBAPP_THEME_MODE = "BleuOn-Subapp-Theme-Mode";
